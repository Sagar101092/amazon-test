...
public class Amazon1 extends Utility {
    ...
    public void searchDelLaptop() throws InterruptedException {
        ...
        Thread.sleep(2000);
        while (true) {
            WebElement element = driver.findElement(By.xpath("//div[@class='a-section a-spacing-none puis-padding-right-small s-title-instructions-style']//h2//a[contains(normalize-space(.), \"Dell Inspiron 16 Plus-7620 Laptop i7-12700H\")]"));
           ...
           // boolean eleSelected = driver.findElement(By.xpath("//div[@class='a-section a-spacing-none puis-padding-right-small s-title-instructions-style']//h2//a[contains(normalize-space(.),'Dell LATITUDE 5300 LAPTOP CORE I5 8365u 8GB 250GB SSD 13.3')]")).isDisplayed();
            if (status) {
                clickOnElement(By.xpath("//div[@class='a-section a-spacing-none puis-padding-right-small s-title-instructions-style']//h2//a[contains(normalize-space(.), \"Dell Inspiron 16 Plus-7620 Laptop i7-12700H\")]"));
                break;
            } else {
